          ...
          <div class="left form-contact-register _sf-col-xs-12-md-push-2-md-8">
              <form id="contact-doonee" name="contact-doonee" method="post" action="<?=base_url('/payment/creditcard_submit')?>">
                  <fieldset class="_sf-col-sm-push-1-sm-10 pd0">
                    <legend class="hid">Thanh toán thẻ tín dụng</legend>
                    <p>
                    ...
                    <p>
                      <label for="id-card" class="hid">13 chữ số ID</label>
                    ...
                    <p class="ctrl-btn-sub mt2">
                      <button type="submit" class="ui-btn btn-profile" name="send" id="send" value="สมัครสมาชิก">Đăng ký</button> <span class="mh1">Hoặc</span> <a title="เข้าสู่ระบบผ่าน Facebook " href="javascript:;" class="fb-signin"><i class="icon-facebook"></i> Connect <span>with</span> Facebook</a>
                    </p>
                  </fieldset>
                </form>
          </div>
